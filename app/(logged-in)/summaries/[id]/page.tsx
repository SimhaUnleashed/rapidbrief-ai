...
async function SummaryPage(props: { params: Promise<{ id: string }> }) {
    ...
    >
      <div className="container mx-auto flex flex-col gap-4">
        ...
        >
          ...
          {file_name && <SourceInfo fileName={file_name} originalFileUrl={summary.original_file_url} title={title} summaryText={summary_text} createdAt={created_at} />}
