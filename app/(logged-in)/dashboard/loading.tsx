...
function SummaryCardSkeleton() {
  return <MotionDiv variants={itemVariants} initial="hidden" animate="visible" className='rounded-lg border bg-card text-card foreground shadow-sm'>
...
export default function LoadingSummaries() {
  return (
    <div className="min-h-screen relative">
      <section className="container px-10 py-24 mx-auto
        flex flex-col gap-4">
        <HeaderSkeleton />
