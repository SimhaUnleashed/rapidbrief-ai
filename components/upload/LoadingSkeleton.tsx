...
export default function LoadingSkeleton() {
  return (
    <Card className="relative px-2 h-[700px] w-[600px]
      max-w-lg mx-auto overflow-hidden bg-linear-to-br
    ...
    <div className="h-full overflow-y-auto
      ...
      <div className="px-6">
        {/* Loading Title */}
        <div className="flex flex-col gap-2 mb-6 sticky
        ...
        >
          <div className="relative flex items-start
            ...
            <Skeleton className="h-6 w-6
              rounded-full bg-rose-500/10 shrink-0" />
            <div className="flex-1">
              <Skeleton className="h-6 w-full
                bg-rose-500/10" />
            </div>
...
<div className="absolute bottom-0 left-0 right-0 p-4
  ...
  <div className="flex justify-between items-center">
    <Skeleton className="rounded-full w-12 h-12
        bg-linear-to-br from-rose-500/50 to-rose-600/
        50" />
      <div className="flex gap-2">
        {[1, 2, 3].map((_, index) => (
          <Skeleton
            key={index}
            className="h-2 s-2 rounded-full
              bg-rose-500/20"
          />
        ))}
      </div>
